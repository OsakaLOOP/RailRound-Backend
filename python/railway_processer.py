...
class RailwayDataService:
    ...
    def build(self):
        ...
        # For now, we try to use files if they exist in the configured dir, otherwise fall back to defaults or specific names
        # To be robust, let's try to match the known filenames if not provided otherwise
